 ...
 * @author Snehal
 */
public class EmployerRegisteredStudentsPanel extends javax.swing.JPanel {
     ...
     * @param userSignUpObj
     */
    public EmployerRegisteredStudentsPanel(JPanel EmpContentPanel,
            UserSignUpModel userSignUpObj) {
        initComponents();
    ...
    private void loadTableData() {
        if (!this.userSignUpObj.getUserLi().isEmpty()) {
            ...
            for (UserModel userObj : this.userSignUpObj.getUserLi()) {
                if (userObj.getUserType().equalsIgnoreCase("student")) {
