...
public class BusinessAdminDataAdministration extends javax.swing.JPanel {
    ...
    public BusinessAdminDataAdministration(ArrayList<User> userData) throws SQLException {
        initComponents();
    ...
    private void populateTableData(String type) throws SQLException {
        ...
        if(type.equalsIgnoreCase("HOTEL")){
            hotelFilteredList = workRequestController.getAllHotelDataService(); 
            ...
            cateringFilteredList = workRequestController.getAllCateringDataService();
            ...
            travelAgentFilteredList = workRequestController.getAllTravelAgentDataService(); 
            ...
            //Load hotel data
            hotelFilteredList = workRequestController.getAllHotelDataService(); //TODO: Pass toId from USER table
            for(Hotel ht: hotelFilteredList){
                Object[] obj = new Object[8];
                obj[0] = ht;
                obj[1] = "HOTEL";
    ...
    private void populateCardData() throws SQLException{
        ...
        jHotelCard.setValues("# " + workRequestController.getAllHotelDataService().size());
        jCateringCard.setValues("# " + workRequestController.getAllCateringDataService().size()); 
        jTravelAgentCard.setValues("# " + workRequestController.getAllTravelAgentDataService().size()); 
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Enterprise", "Address", "Area",
                "Capacity", "Email", "Phone","Status"
            }
        ) {
